...
<div class="container">
    <div class="card card-login mx-auto mt-5">
        <div class="card-header">E-Mail Address Verification - Login</div>
        <div class="card-body">
            <img src="img/mail-verify-logo.png" style="margin-left: 20%; " alt="E-Mail Address Verification Logo" id="logo">
            <form>
                <div class="form-group">
                    <form id="loginForm" onsubmit="return(false);">
                        <label for="email">Email address</label>
                        <input class="form-control" id="email" name="usermail" type="usermail" aria-describedby="emailHelp"
